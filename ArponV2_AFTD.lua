...
local function startfarming()
    if game.PlaceId == 16474126979 and not Settings.farmprotal and Settings.autostart and Settings.AutoFarm and Settings.teleporting and not Settings.AutoInfinityCastle then
...
coroutine.resume(coroutine.create(function()
    while task.wait(0.1) do
        if game.PlaceId ~= 16474126979 and Settings.AutoFarm and Settings.unitconfig and not getgenv().disableatuofarm then
...
coroutine.resume(coroutine.create(function()
    while task.wait(0.1) do
        if game.PlaceId ~= 16474126979 and Settings.AutoFarm and not Settings.unitconfig and not getgenv().disableatuofarm then
...
coroutine.resume(coroutine.create(function()
    while task.wait(1.5) do
        if game.PlaceId ~= 16474126979 and Settings.deletemap2 then
            local _wave = game:GetService("Workspace"):WaitForChild("_wave_num")
            repeat task.wait() until game:GetService("Workspace"):WaitForChild("_map")
			DelTer() 
			DelMapMain()
